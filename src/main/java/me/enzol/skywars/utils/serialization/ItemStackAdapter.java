...
public class ItemStackAdapter implements JsonDeserializer<ItemStack>, JsonSerializer<ItemStack> {
    ...
    public static JsonElement serialize(ItemStack source) {
        ...
        object.addProperty("type", source.getType().name());
        ...
        if (source.hasItemMeta()) {
            ...
            if (itemMeta.hasDisplayName()) object.addProperty("name", itemMeta.getDisplayName());

            if (itemMeta.hasLore()) object.add("lore", listToJson(itemMeta.getLore()));
    ...
    public static ItemStack deserialize(JsonElement source) {
        ...
        final Material type = Material.valueOf(element.get("type").getAsString());
        ...
        final ItemStack itemStack = new ItemStack(type, count, data);
